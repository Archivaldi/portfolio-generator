...
const generateAbout = aboutText => {
  ...
  const generateProjects = projectsArr => {
    ...
    const featuredProjects = projectsArr.filter(project => project.feature ? true : false);
  
    // get array of all non-featured projects
    const nonFeaturedProjects = projectsArr.filter(project => !project.feature ? true : false);
